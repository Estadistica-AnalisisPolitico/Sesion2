...
Profesores de la Universidad de los Andes [@mejiaguinand2008] decidieron estudiar cómo la _distribución de fondos públicos_ fue afectada por _factores políticos_ durante el primer periodo del Presidente Uribe (2002-2006). Las hipótesis que se plantean son:
...
La tabla \@ref(tab:prettyRegAllic) muestra que los valores no significativos incluyen al cero en el intervalo de confianza (salvo en el caso de _pctopo_ para el modelo 3, con significancia al 0.1). Gráficamente:
